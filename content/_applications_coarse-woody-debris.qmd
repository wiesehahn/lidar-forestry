...
> ALS-detected deadwood can indicate forest conservation value.
ALS data can be used to map forest conservation values and inform decisions about which forests should be used for timber production and which should be set aside as conservation areas.  [@huoEstimatingConservationValue2023]
